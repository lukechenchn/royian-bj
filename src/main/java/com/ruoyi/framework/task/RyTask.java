...
public class RyTask {
    ...
    //1#
    public static final String P1 = "L4";
    //出库
    public static final String CHUKU1 = "L2";
    //待命区
    public static final String DAIMINGQU1 = "L4";
    //弹射区
    ...
    //2#   12#
    //起始点
    public static final String P2 = "L5";
    //出库
    public static final String CHUKU2 = "L3";
    //待命区
    public static final String DAIMINGQU2 = "L1";
    //弹射区
    public static final String TANSHEQU2 = "L2";
    ...
    public void agvStatusQuery() {
        ...
        for (Map<String, Object> agv : agvList) {
            ...
            String b = "";
            String c = "";
            double xMeter = Double.parseDouble(x) / 1000.0;
            double yMeter = Double.parseDouble(y) / 1000.0;
            double zMeter = Double.parseDouble(z) / 1000.0;
// 将毫米转换为米
            // 格式化为字符串，保留3位小数
            a = String.format("%.1f", xMeter);
            b = String.format("%.1f", yMeter);
            c = String.format("%.1f", zMeter);

            String positionDb = "(" + a + ", " + b + ", " + c + ")";
            ...
            String agvNo = vehicleName;

            try {
                int agvNumber = Integer.parseInt(agvNo);
                agvNo = String.format("%02d", agvNumber);
            } catch (NumberFormatException e) {
                // 如果无法解析为数字，保持原始值
                System.err.println("无法解析AGV编号: " + agvNo);
            }
            // 更新AGV状态
                ...
                try {
                    ...
                    if (signNo.equals("055")) {
                        ...
                        if (agv.equals("01")) {
                            ...
                            tmpParam.put("AGVNum", 1);
                            tmpParam.put("MissionUid", taskId);
                            tmpParam.put("StationName", "L1");
                            tmpParam.put("Balance", 0);
                            BjUtil.postJson(url, tmpParam.toString());
                        }
                    }
                    ...
                    if (signNo.equals("060")) {
                        ...
                        if (agv.equals("01")) {
                            ...
                            JSONObject tmpParam = new JSONObject();
                            tmpParam.put("AGVNum", 1);
                            tmpParam.put("MissionUid", taskId +  "01");
                            tmpParam.put("StationName", "L2");
                            tmpParam.put("Balance", 2);
                            BjUtil.postJson(url, tmpParam.toString());
                            //等待2秒
                            Thread.sleep(2000);
                            tmpParam.put("Balance", 4);
                            tmpParam.put("MissionUid", taskId);
                            BjUtil.postJson(url, tmpParam.toString());
                        }
                    }
                    ...
                    if (signNo.equals("075")) {
                        ...
                        if (agv.equals("01")) {
                            ...
                            tmpParam.put("MissionUid", taskId +  "01");
                            tmpParam.put("StationName", "L2");
                            tmpParam.put("Balance", 5);
                            BjUtil.postJson(url, tmpParam.toString());
                            //等待2秒
                            Thread.sleep(2000);
                            tmpParam.put("Balance", 3);
                            tmpParam.put("MissionUid", taskId);
                            BjUtil.postJson(url, tmpParam.toString());
                        }
                    }
